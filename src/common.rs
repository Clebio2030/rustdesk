...
pub fn is_rustdesk() -> bool {
    hbb_common::config::APP_NAME.read().unwrap().eq("MaxDesk")
}
...
fn get_api_server_(api: String, custom: String) -> String {
    ...
    "https://maxdesk.csdigitalz.com.br".to_owned()
}
...
pub fn load_custom_client() {
    // MaxDesk: embute o Servidor da API por padrao. or_insert preserva custom.txt.
    // (O aviso "configure seu proprio servidor" e escondido na UI via isCustomClient,
    //  nao aqui — ver connection_page.dart. Mexer em custom-rendezvous-server aqui
    //  nao surtia efeito no banner por causa do plumbing do OPTIONS.)
    {
